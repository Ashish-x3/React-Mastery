...
const ToggleSwitch = () => {
    ...
    return (
        <div className="min-h-screen p-8 bg-white dark:bg-slate-900 text-black dark:text-white transition-colors duration-200">
            <button
                onClick={toggleTheme}
            ...
            >
                Toggle {theme} Theme {theme == 'dark' ? <Sun /> : <Moon />}
            </button>
